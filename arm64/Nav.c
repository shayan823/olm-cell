...
#define h_forwardRate_TIME_SCALE _p[13]
#define h_forwardRate_VOLT_SCALE _p[14]
#define h_reverseRate_rate _p[15]
#define h_reverseRate_midpoint _p[16]
#define h_reverseRate_scale _p[17]
...
#define m_reverseRate_x _p[24]
#define m_reverseRate_r _p[25]
#define m_q10Settings_q10 _p[26]
#define m_rateScale _p[27]
#define m_alpha _p[28]
#define m_beta _p[29]
#define m_fcond _p[30]
#define m_inf _p[31]
#define m_tau _p[32]
#define h_forwardRate_V _p[33]
#define h_forwardRate_r _p[34]
#define h_reverseRate_r _p[35]
#define h_q10Settings_q10 _p[36]
#define h_rateScale _p[37]
#define h_alpha _p[38]
#define h_beta _p[39]
#define h_fcond _p[40]
#define h_inf _p[41]
#define h_tau _p[42]
...
#define ena _p[50]
#define ina _p[51]
#define rate_m_q _p[52]
#define rate_h_q _p[53]
#define Dm_q _p[54]
#define Dh_q _p[55]
#define v _p[56]
#define _g _p[57]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmax_Nav", "S/cm2",
 "conductance_Nav", "uS",
 "m_forwardRate_rate_Nav", "kHz",
 "m_forwardRate_midpoint_Nav", "mV",
 "m_forwardRate_scale_Nav", "mV",
 "m_reverseRate_rate_Nav", "kHz",
 "m_reverseRate_midpoint_Nav", "mV",
 "m_reverseRate_scale_Nav", "mV",
 "m_q10Settings_experimentalTemp_Nav", "K",
 "m_q10Settings_TENDEGREES_Nav", "K",
 "h_forwardRate_TIME_SCALE_Nav", "ms",
 "h_forwardRate_VOLT_SCALE_Nav", "mV",
 "h_reverseRate_rate_Nav", "kHz",
 "h_reverseRate_midpoint_Nav", "mV",
 "h_reverseRate_scale_Nav", "mV",
 "h_q10Settings_experimentalTemp_Nav", "K",
 "h_q10Settings_TENDEGREES_Nav", "K",
 "gion_Nav", "S/cm2",
 "m_forwardRate_r_Nav", "kHz",
 "m_reverseRate_r_Nav", "kHz",
 "m_alpha_Nav", "kHz",
 "m_beta_Nav", "kHz",
 "m_tau_Nav", "ms",
 "h_forwardRate_r_Nav", "kHz",
 "h_reverseRate_r_Nav", "kHz",
 "h_alpha_Nav", "kHz",
 "h_beta_Nav", "kHz",
 "h_tau_Nav", "ms",
 "g_Nav", "uS",
...
"Nav",
 ...
 "conductance_Nav",
 "m_instances_Nav",
 "m_forwardRate_rate_Nav",
 "m_forwardRate_midpoint_Nav",
 "m_forwardRate_scale_Nav",
 "m_reverseRate_rate_Nav",
 "m_reverseRate_midpoint_Nav",
 "m_reverseRate_scale_Nav",
 "m_q10Settings_q10Factor_Nav",
 "m_q10Settings_experimentalTemp_Nav",
 "m_q10Settings_TENDEGREES_Nav",
 "h_instances_Nav",
 "h_forwardRate_TIME_SCALE_Nav",
 "h_forwardRate_VOLT_SCALE_Nav",
 "h_reverseRate_rate_Nav",
 "h_reverseRate_midpoint_Nav",
 "h_reverseRate_scale_Nav",
 "h_q10Settings_q10Factor_Nav",
 "h_q10Settings_experimentalTemp_Nav",
 "h_q10Settings_TENDEGREES_Nav",
 0,
 "gion_Nav",
 "m_forwardRate_x_Nav",
 "m_forwardRate_r_Nav",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	conductance = 1e-06;
 	m_instances = 3;
 	m_forwardRate_rate = 1.5;
 	m_forwardRate_midpoint = -43;
 	m_forwardRate_scale = 5;
 	m_reverseRate_rate = 1.5;
 	m_reverseRate_midpoint = -15;
 	m_reverseRate_scale = -5;
 	m_q10Settings_q10Factor = 3;
 	m_q10Settings_experimentalTemp = 307.15;
 	m_q10Settings_TENDEGREES = 10;
 	h_instances = 1;
 	h_forwardRate_TIME_SCALE = 1;
 	h_forwardRate_VOLT_SCALE = 1;
 	h_reverseRate_rate = 3.33;
 	h_reverseRate_midpoint = -12.5;
 	h_reverseRate_scale = 10;
 	h_q10Settings_q10Factor = 3;
 	h_q10Settings_experimentalTemp = 307.15;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nav /Users/shayan/Desktop/CN/gsoc_cn/olm_multicompartmental/Nav.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=Nav type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   h_forwardRate_r = ( 0.23 / ( exp ( ( h_forwardRate_V + 65.0 ) / 20.0 ) ) ) / h_forwardRate_TIME_SCALE ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shayan/Desktop/CN/gsoc_cn/olm_multicompartmental/Nav.mod";
static const char* nmodl_file_text = 
