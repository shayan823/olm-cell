...
#define nrn_init _nrn_init__Kdrfast
#define _nrn_initial _nrn_initial__Kdrfast
#define nrn_cur _nrn_cur__Kdrfast
#define _nrn_current _nrn_current__Kdrfast
#define nrn_jacob _nrn_jacob__Kdrfast
#define nrn_state _nrn_state__Kdrfast
#define _net_receive _net_receive__Kdrfast 
#define rates rates__Kdrfast 
#define states states__Kdrfast 
...
#define n_reverseRate_TIME_SCALE _p[6]
#define n_reverseRate_VOLT_SCALE _p[7]
#define n_q10Settings_q10Factor _p[8]
#define n_q10Settings_experimentalTemp _p[9]
#define n_q10Settings_TENDEGREES _p[10]
#define gion _p[11]
#define n_forwardRate_x _p[12]
#define n_forwardRate_r _p[13]
#define n_reverseRate_V _p[14]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Kdrfast", _hoc_setdata,
 "rates_Kdrfast", _hoc_rates,
 0, 0
};
 ...
 "gmax_Kdrfast", "S/cm2",
 "conductance_Kdrfast", "uS",
 "n_forwardRate_rate_Kdrfast", "kHz",
 "n_forwardRate_midpoint_Kdrfast", "mV",
 "n_forwardRate_scale_Kdrfast", "mV",
 "n_reverseRate_TIME_SCALE_Kdrfast", "ms",
 "n_reverseRate_VOLT_SCALE_Kdrfast", "mV",
 "n_q10Settings_experimentalTemp_Kdrfast", "K",
 "n_q10Settings_TENDEGREES_Kdrfast", "K",
 "gion_Kdrfast", "S/cm2",
 "n_forwardRate_r_Kdrfast", "kHz",
 "n_reverseRate_r_Kdrfast", "kHz",
 "n_alpha_Kdrfast", "kHz",
 "n_beta_Kdrfast", "kHz",
 "n_tau_Kdrfast", "ms",
 "g_Kdrfast", "uS",
...
"Kdrfast",
 ...
 "conductance_Kdrfast",
 "n_instances_Kdrfast",
 "n_forwardRate_rate_Kdrfast",
 "n_forwardRate_midpoint_Kdrfast",
 "n_forwardRate_scale_Kdrfast",
 "n_reverseRate_TIME_SCALE_Kdrfast",
 "n_reverseRate_VOLT_SCALE_Kdrfast",
 "n_q10Settings_q10Factor_Kdrfast",
 "n_q10Settings_experimentalTemp_Kdrfast",
 "n_q10Settings_TENDEGREES_Kdrfast",
 0,
 "gion_Kdrfast",
 "n_forwardRate_x_Kdrfast",
 "n_forwardRate_r_Kdrfast",
 "n_reverseRate_V_Kdrfast",
 "n_reverseRate_r_Kdrfast",
 "n_q10Settings_q10_Kdrfast",
 "n_rateScale_Kdrfast",
 "n_alpha_Kdrfast",
 "n_beta_Kdrfast",
 "n_fcond_Kdrfast",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	conductance = 1e-06;
 	n_instances = 4;
 	n_forwardRate_rate = 0.42;
 	n_forwardRate_midpoint = -18;
 	n_forwardRate_scale = 6;
 	n_reverseRate_TIME_SCALE = 1;
 	n_reverseRate_VOLT_SCALE = 1;
 	n_q10Settings_q10Factor = 3;
 	n_q10Settings_experimentalTemp = 307.15;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kdrfast /Users/shayan/Desktop/CN/gsoc_cn/olm_multicompartmental/Kdrfast.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=Kdrfast type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   n_reverseRate_r = ( ( 0.264 ) / ( exp ( ( n_reverseRate_V + 43.0 ) / 40.0 ) ) ) / n_reverseRate_TIME_SCALE ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shayan/Desktop/CN/gsoc_cn/olm_multicompartmental/Kdrfast.mod";
static const char* nmodl_file_text = 
